...
<head>
  ...
  <link type="text/css" href="<php echo base_url('URCstyles/vendor/fontawesome-free/css/all.min.css');?>" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
  <script src="http://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
  <Custom styles for this template
  <link type="text/css" href="<php echo base_url('URCstyles/css/sb-admin-2.min.css');?>" rel="stylesheet">
 
  <-- Datatables files
  <link rel="stylesheet" href="<php echo base_url('URCstyles/css/dataTables.bootstrap.min.css');?>">
  -->
  <!-- bogaloo -->
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    <div class="small text-gray-500">December 2, 2019</div>
                     Alert: Your Submission is been unsubmitted. Please check your email.
                  </div>
                </a>
