...
<div class="container-fluid">
    ...
    <div class="form-row">
        <div class="form-group col-md-8">
            ...
            <select id="researchID" name="research" onchange="displayForm(this)" class="form-control" disabled>
    ...
    <div id="thesis">
        ...
        <div class="form-row">
            <div class="form-group col-md-5">
                ...
                <input type="text" value="<?php echo $row->cr_first;?>" name="thesisFirst" class="form-control" disabled>
                <span class="text-danger"><?php echo form_error("thesisFirst");?></span>
            </div>
            <div class="form-group col-md-2">
                <label>Middle Initial(s)*</label>
                <input type="text" value="<?php echo $row->cr_middle;?>" name="thesisMiddle" class="form-control" disabled>
                <span class="text-danger"><?php echo form_error("thesisMiddle");?></span>
            </div>
            <div class="form-group col-md-5">
                <label>Last Name*</label>
                <input type="text" value="<?php echo $row->cr_last;?>" name="thesisLast" class="form-control" disabled>
        ...
        <div class="form-row">
            <div class="form-group col-md-2">
                ...
                <input type="text" value="<?php echo $row->cr_year;?>" name="thesisYear" class="form-control" disabled>
            </div>
            <div class="form-group col-md-5">
                <label>Title of thesis / dissertation*</label>
                <input type="text" value="<?php echo $row->cr_title;?>" name="thesisTitle" class="form-control" disabled>
            </div>
            <div class="form-group col-md-5">
                <label>URL for published thesis</label>
                <input type="text" value="<?php echo $row->cr_url;?>" name="thesisURL" class="form-control" disabled>
            </div>
        </div>
        <div class="form-group">
            <label>Institution where thesis was completed*</label>
            <input type="text" class="form-control" name="thesisInstitute" value="<?php echo $row->cr_institute;?>" disabled>
        </div>
        <div class="form-group">
            <label>Location of Institute*</label>
                <input type="text" name="thesisLocation" value="<?php echo $row->cr_location;?>" class="form-control" disabled>
        ...
        <div class="form-group">
            ...
            <input type="file" value="<?php echo $row->cr_file;?>" name="thesisFile" class="form-control-file" disabled>
            <a href="<?=base_url().'pdf/'.$row->cr_file;?>" target="_blank">test</a>
        </div>
        <div class="form-group" style="text-align:center;">
            <a href="<?php echo base_url('admin/approve_submissions/'.$row->cr_id);?>" class="btn btn-primary">Accept</a> <a href="<?php echo base_url('admin/unsubmit_submissions/'.$row->cr_id);?>" class="btn btn-danger">Unsubmit</a>
        </div>
        </form>
    </div>
    <!-- ./Thesis / Dissertation form -->
