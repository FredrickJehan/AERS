...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2020 at 10:46 PM
...
(207, 2, 95, 'Kyle Jhon', 'T.', 'Daluro', 1, 'Main'),
(208, 2, 95, 'Kyle Jhon', 'T.', 'Daluro', 1, 'Extra'),
(209, 2, 96, 'Kyle Jhon', 'A.', 'Nolan', 1, ''),
(210, 2, 96, 'Kyle Jhon', 'A.', 'Nolan', 1, '');
...
INSERT INTO `comment` (`comment_id`, `publication_id`, `user_id`, `message`, `time_created`) VALUES
(1, 95, 2, 'test\r\n', '2020-09-22 15:06:03');
...
(76, 96, 'Teaching critical literacy: Case studies of teachers in the Philippines', 2019, 'Naga City', 'Ateneo de Naga University', 'http://www.uow.edu.au./theses/45789', 'Thesis / Dissertation');
...
INSERT INTO `like_tbl` (`like_id`, `user_id`, `pub_id`) VALUES
(122, 1, 95),
(123, 2, 95);
...
(19, 1, 70, 'Review', '2020-09-18 21:40:50', 'Read'),
(20, 2, 95, 'Comment', '2020-09-22 23:06:03', 'Read');
...
(5, 95, 'Teaching critical literacy: Case studies of teachers in the Philippines', '2000-02', 'Paper presented at the Annual Convention of the Southeastern Psychological Association', 'Chattanooga, TN', 'Conference Paper');
...
(91, 'ACCOUTING_Module17.pdf', 'test2', 0, 'Unreviewed', NULL, 'Completed Research', 'Sep 17 2020', 2),
(92, 'SALES_AND_MARKETING_Module11.pdf', 'test3', 0, 'Unreviewed', NULL, 'Completed Research', 'Sep 17 2020', 2),
(94, 'SALES_AND_MARKETING_Module12.pdf', 'test5', 0, 'Rejected', 'test', 'Completed Research', 'Sep 17 2020', 2),
(95, 'aers_data24.pdf', NULL, 5, 'Unreviewed', NULL, 'Presented Research', 'Sep 19 2020', 2),
(96, 'aers_data25.pdf', 'asdas', 0, 'Unreviewed', NULL, 'Completed Research', 'Sep 22 2020', 2);
...
--
ALTER TABLE `author`
  MODIFY `author_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=211;
...
--
ALTER TABLE `completed`
  MODIFY `completed_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
ALTER TABLE `like_tbl`
  MODIFY `like_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `presented`
  MODIFY `presented_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `publication`
--
ALTER TABLE `publication`
  MODIFY `publication_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
...
ALTER TABLE `like_tbl`
  ...
  ADD CONSTRAINT `like_tbl_ibfk_2` FOREIGN KEY (`pub_id`) REFERENCES `publication` (`publication_id`);
